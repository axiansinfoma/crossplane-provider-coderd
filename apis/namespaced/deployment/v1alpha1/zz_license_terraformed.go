...
// GetID returns ID of underlying Terraform resource of this License
...
// GetInitParameters of this License
func (tr *License) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this License
func (tr *License) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this License using its observed tfState.
